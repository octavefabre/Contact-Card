...
app.delete("/contacts/:id", (req, res) => {
  ...
  // si dernier contact du label => supprime le label
  if (contact.labelId !== null) {
    const count = db.prepare("SELECT COUNT(*) as n FROM contacts WHERE labelId = ?").get(contact.labelId).n;
